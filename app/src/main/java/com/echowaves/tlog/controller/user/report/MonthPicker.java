...
public class MonthPicker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton = (Button) findViewById(R.id.user_reports_activity_month_picker_backButton);
        ...
        listView = (ListView) findViewById(R.id.user_reports_activity_month_picker_listView);
